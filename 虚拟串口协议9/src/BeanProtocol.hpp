...
static const uint8_t NUMBER_HEADER = 0xCC;// 固定5个位置（左到右），检测到数字标签后排序填入
static const uint32_t NUMBER_PACKET_SIZE = 8;// [0xCC] [pos1:1] [pos2:1] [pos3:1] [pos4:1] [pos5:1] [crc:2]
